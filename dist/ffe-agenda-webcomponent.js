          ...
          <div class="flex-1">
            ...
            <div class="mb-8">
              <a
                ...
                rel="noopener"
              >
                ${W("arrowRight")} Voir sur le site FFE
              </a>
            </div>
          </div>
        </div>
        ...
        return f`
              ...
              >
                ...
                <div class="ml-auto flex items-center gap-2 ">
                  ...
                  <div class="w-[8ch] text-right">${e.elo}</div>
                </div>
              </div>
              ${s ? c : f`<div
